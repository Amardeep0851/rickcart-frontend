...
export default function RegisterPage() {
  ...
  return (
      <Card className="w-full  max-w-md bg-zinc-900/50 border border-zinc-700 shadow-lg">
          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <Label htmlFor="firstName" className="text-zinc-300 font-semibold pb-2">
                    First name
                  </Label>
                  <Input
                    id="firstName"
                    ...
                    className="mt-1 bg-zinc-800 text-zinc-200"
                  />
                  {errors.firstName && (
                ...
                <div>
                  <Label htmlFor="lastName" className="text-zinc-300  font-semibold pb-2">
                    Last name
                  </Label>
                  <Input
                    id="lastName"
              ...
              <div>
                <Label htmlFor="email" className="text-zinc-300  font-semibold pb-2">
                  Email address
                </Label>
                <Input
                  id="email"
              ...
              <div>
                <Label htmlFor="password" className="text-zinc-300  font-semibold pb-2">
                  Password
                </Label>
