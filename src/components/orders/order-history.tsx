  ...
  return (
    <div className="space-y-6">
        {orders.map((order:any) => (
          ...
          >
            <div className="flex justify-between items-start mb-4 dark:text-zinc-200 text-zinc-800">
            ...
            <div className="flex items-center space-x-6 border-t dark:border-zinc-700 border-zinc-300  pt-4">
              ...
              <div className="flex-1 ">
                ...
                <div className="mt-3 flex gap-3">
                  <Button className="cursor-pointer bg-zinc-50 hover:bg-zinc-100" variant="outline" size="sm">
                    Buy it again
                  </Button>
                  <Button 
                  onClick={() => setSelectedOrder(true)}
                  className="cursor-pointer bg-orange-700 hover:bg-orange-800 text-white"   size="sm">
                    View detail
                  </Button>
                </div>
              </div>
