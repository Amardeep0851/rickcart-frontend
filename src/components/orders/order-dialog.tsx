...
function OrderDialog({ selectedOrder, setSelectedOrder, orders }:OrderDialogProps) {
  ...
  return (
    <div className="">
      <Dialog onOpenChange={setSelectedOrder} open={selectedOrder}>
        <DialogContent className="md:min-w-[700px] dark:bg-zinc-900 bg-zinc-100 print-area "  ref={componentRef}>
          <DialogHeader>
          ...
          <DialogDescription>
            <div className="md:flex md:justify-between text-sm border-b dark:border-zinc-700 border-zinc-300 pb-4 mb-4 " >
              <p>Order number: id</p>
              <p>Order placed: date</p>
            </div>
            <div className="md:grid md:grid-cols-3 gap-4 border-b dark:border-zinc-700 border-zinc-300 p-4  mb-4">
              <div>
              ...
              <div>
                ...
                <p className="text-zinc-300 text-sm">payment</p>
              </div>
              <div>
                <h3 className="font-semibold mb-1">Order Summary</h3>
                <p className="text-sm">Item(s) Subtotal: {orders.subtotal}</p>
                <p className="text-sm">Shipping: {orders.shipping}</p>
